...
/**
 * Job to delete user ad hoc datum export tasks that have completed processing.
 * 
 * @author matt
 * @version 1.0
 * @since 1.1
 */
public class UserAdhocExportTaskCleanerJob extends JobSupport {

	/** The default value for the {@code minimumAgeMinutes} property. */
	public static final int DEFAULT_MINIMUM_AGE_MINUTES = 360;

	private final UserAdhocDatumExportTaskInfoDao taskDao;
	 ...
	 *        the DAO to use
	 */
	public UserAdhocExportTaskCleanerJob(EventAdmin eventAdmin,
			UserAdhocDatumExportTaskInfoDao taskDao) {
		super(eventAdmin);
	...
	protected boolean handleJob(Event job) throws Exception {
		...
		log.info("Purged {} completed user ad hoc datum export tasks older than {} minutes", result,
				minimumAgeMinutes);
		return true;
	}
