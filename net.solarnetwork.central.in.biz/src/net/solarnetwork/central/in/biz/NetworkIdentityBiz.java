...
public interface NetworkIdentityBiz {
	 ...
	 * 
	 * <p>This is the information that should be publicly available for users 
	 * to view, so they can validate this against the same info presented
	 * during node association.</p>
	 * 
	 * @return identity key
	 */
