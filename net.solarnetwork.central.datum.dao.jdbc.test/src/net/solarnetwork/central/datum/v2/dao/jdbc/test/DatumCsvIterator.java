...
public class DatumCsvIterator implements Iterator<Datum>, Closeable {
	...
	protected Datum parseRow(List<String> row) throws IOException {
		...
		props.setInstantaneous(parseDecimalColummns(row,
				meta.propertyNamesForType(GeneralDatumSamplesType.Instantaneous)));
		props.setAccumulating(parseDecimalColummns(row,
				meta.propertyNamesForType(GeneralDatumSamplesType.Accumulating)));
		props.setStatus(
				parseStringColumns(row, meta.propertyNamesForType(GeneralDatumSamplesType.Status)));
