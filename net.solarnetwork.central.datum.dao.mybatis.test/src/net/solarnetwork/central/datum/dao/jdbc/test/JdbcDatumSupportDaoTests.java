...
public class JdbcDatumSupportDaoTests extends BaseDatumJdbcTestSupport {
	...
	@Test
	public void userIdForNodeId_noMatch() {
		// GIVEN
		...
		// THEN
		assertThat("Null returned when no match", userId, nullValue());
	}

	@Test
	public void userIdForNodeId_match() {
		// GIVEN
		...
		// THEN
		assertThat("User ID found", userId, equalTo(TEST_USER_ID));
	}
