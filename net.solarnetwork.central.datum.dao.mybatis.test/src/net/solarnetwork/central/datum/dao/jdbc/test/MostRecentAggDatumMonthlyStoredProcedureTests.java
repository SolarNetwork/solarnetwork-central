 ...
 * @version 1.0
 */
public class MostRecentAggDatumMonthlyStoredProcedureTests extends BaseDatumJdbcTestSupport {

	private List<Map<String, Object>> queryForMostRecentDatumMonthly(Long[] nodeIds,
			String[] sourceIds) {
		return jdbcTemplate.queryForList(
				"select * from solaragg.find_most_recent_monthly(?::bigint[],?::text[])",
	...
	public void mostRecent_multiNodes_allSources_multiMatch() {
		...
		// WHEN
		List<Map<String, Object>> rows = queryForMostRecentDatumMonthly(
