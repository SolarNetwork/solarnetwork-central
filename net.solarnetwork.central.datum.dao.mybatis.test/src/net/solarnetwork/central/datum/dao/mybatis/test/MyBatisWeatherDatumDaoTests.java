/* ==================================================================
 * MyBatisWeatherDatumDaoTests.java - Nov 14, 2014 10:30:24 AM
 * 
...
import net.solarnetwork.central.datum.dao.mybatis.MyBatisWeatherDatumDao;
...
/**
 * Test cases for the {@link MyBatisWeatherDatumDao} class.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisWeatherDatumDaoTests extends AbstractMyBatisDaoTestSupport {

	private MyBatisWeatherDatumDao dao;

	private WeatherDatum lastDatum;

	@Before
	public void setUp() {
		dao = new MyBatisWeatherDatumDao();
