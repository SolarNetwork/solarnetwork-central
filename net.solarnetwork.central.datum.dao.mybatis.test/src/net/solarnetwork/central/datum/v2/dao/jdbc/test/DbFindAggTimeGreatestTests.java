...
public class DbFindAggTimeGreatestTests extends BaseDatumJdbcTestSupport {
	...
	private List<AggregateDatumEntity> findAggTimeGreatest(UUID[] streamIds, Aggregation kind) {
	...
	public void findAggTimeGreatest_noData() {
		...
		for ( Aggregation kind : aggs() ) {
			List<AggregateDatumEntity> results = findAggTimeGreatest(new UUID[] { streamId }, kind);
	...
	public void findAggTimeGreatest_hour_oneStream() throws IOException {
		...
		// WHEN
		List<AggregateDatumEntity> results = findAggTimeGreatest(new UUID[] { streamId },
				Aggregation.Hour);
	...
	public void findAggTimeGreatest_hour_twoStreams() throws IOException {
		...
		// WHEN
		List<AggregateDatumEntity> results = findAggTimeGreatest(
