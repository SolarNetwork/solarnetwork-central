...
public class DatumAuxiliaryEntity extends BasicIdentity<DatumAuxiliaryPK>
	...
	private final GeneralDatumSamples samplesFinal;
	private final GeneralDatumSamples samplesStart;
	 ...
	 *        the metadata
	 */
	public DatumAuxiliaryEntity(DatumAuxiliaryPK id, Instant updated, GeneralDatumSamples samplesFinal,
			GeneralDatumSamples samplesStart, String notes, GeneralDatumMetadata metadata) {
		super(id);
	...
	public DatumAuxiliaryEntity(UUID streamId, Instant timestamp, DatumAuxiliaryType kind,
			Instant updated, GeneralDatumSamples samplesFinal, GeneralDatumSamples samplesStart,
			String notes, GeneralDatumMetadata metadata) {
	...
	@Override
	public GeneralDatumSamples getSamplesFinal() {
		return samplesFinal;
	}

	@Override
	public GeneralDatumSamples getSamplesStart() {
		return samplesStart;
	}
