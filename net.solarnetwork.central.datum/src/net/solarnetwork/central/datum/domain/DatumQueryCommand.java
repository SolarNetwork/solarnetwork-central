...
public class DatumQueryCommand implements Cachable {
	...
	public String getCacheKey() {
		String data = Arrays.toString(nodeIds)
			+ Arrays.toString(sourceIds)
	 ...
	 * 
	 * <p>This method will return <em>false</em> if no {@code aggregate}
	 * value has been set.</p>
	 * 
	 * @param agg the aggregation to test
	 * @return boolean
	 */
	 ...
	 * 
	 * <p>This is a convenience method for requests that use a single node ID
	 * at a time. The node ID is still stored on the {@code nodeIds} array, just
	 * as the first value. Calling this method replaces any existing {@code nodeIds}
	 * value with a new array containing just the ID passed into this method.</p>
	 * 
	 ...
	 * 
	 * <p>This returns the first available node ID from the {@code nodeIds} array,
	 * or <em>null</em> if not available.</p>
	 * 
	 * @return the first node ID
	 */
	public Long getNodeId() {
		return this.nodeIds == null || this.nodeIds.length < 1 
			? null : this.nodeIds[0];
	}
	 ...
	 * 
	 * <p>This is a convenience method for requests that use a single source ID
	 * at a time. The source ID is still stored on the {@code sourceIds} array, just
	 * as the first value. Calling this method replaces any existing {@code sourceIds}
	 * value with a new array containing just the ID passed into this method.</p>
	 * 
	 * @param nodeId the ID of the node
	 */
	 ...
	 * 
	 * <p>This returns the first available source ID from the {@code locationIds} array,
	 * or <em>null</em> if not available.</p>
	 * 
	 * @return the first node ID
	 */
	public Long getLocationId() {
		return this.locationIds == null || this.locationIds.length < 1 
			? null : this.locationIds[0];
	}
	
	/**
	 * Set a single location ID.
	 * 
	 * <p>This is a convenience method for requests that use a single location ID
	 * at a time. The location ID is still stored on the {@code locationIds} array, just
	 * as the first value. Calling this method replaces any existing {@code locationIds}
	 * value with a new array containing just the ID passed into this method.</p>
	 * 
	 * @param nodeId the ID of the node
	 */
	 ...
	 * 
	 * <p>This returns the first available source ID from the {@code sourceIds} array,
	 * or <em>null</em> if not available.</p>
	 * 
	 * @return the first node ID
	 */
	public String getSourceId() {
		return this.sourceIds == null || this.sourceIds.length < 1 
			? null : this.sourceIds[0];
	}
	
	/**
	 * Set a property value.
	 * 
	 * <p>This will replace any existing property value for the same key.</p>
	 * 
	 * @param key the key
