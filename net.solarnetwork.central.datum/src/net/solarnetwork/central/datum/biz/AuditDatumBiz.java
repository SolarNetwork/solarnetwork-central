...
public interface AuditDatumBiz {
	 ...
	 *             {@link #findAuditDatumFiltered(AuditDatumCriteria)}
	 */
	@Deprecated
	net.solarnetwork.central.domain.FilterResults<AuditDatumRecordCounts> findFilteredAuditRecordCounts(
	 ...
	 * @return the results, never {@literal null}
	 * @deprecated since 1.1; use
	 *             {@link #findAccumulativeAuditDatumFiltered(AuditDatumCriteria)}
	 */
	@Deprecated
	net.solarnetwork.central.domain.FilterResults<AuditDatumRecordCounts> findFilteredAccumulativeAuditRecordCounts(
			AggregateGeneralNodeDatumFilter filter,
			List<net.solarnetwork.central.domain.SortDescriptor> sortDescriptors, Integer offset,
			Integer max);
