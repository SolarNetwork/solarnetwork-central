...
public class DatumImportProgressInputStream extends CountingInputStream {
	 ...
	 */
	public DatumImportProgressInputStream(InputStream in, long expectedLength, DatumImportService progressContext,
	...
	protected synchronized void afterRead(int n) {
		...
		if ( n > 0 && progressListener != null ) {
			progressListener.progressChanged(this.progressContext,
					Math.min(1.0, (double) getByteCount() / (double) expectedLength));
		}
	}
