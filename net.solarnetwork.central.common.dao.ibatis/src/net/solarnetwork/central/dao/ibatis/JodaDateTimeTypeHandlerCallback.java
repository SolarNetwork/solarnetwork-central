/* ===================================================================
 * JodaDateTimeTypeHandlerCallback.java
 * 
...
/**
 * Implementation of {@link TypeHandlerCallback} for dealing with Joda Time DateTime objects.
 *
 * @author matt
 * @version $Revision$ $Date$
 */
public class JodaDateTimeTypeHandlerCallback implements TypeHandlerCallback {
	...
	public void setParameter(ParameterSetter setter, Object parameter) throws SQLException {
		if ( parameter == null ) {
			...
			Calendar c = Calendar.getInstance(p.getZone().toTimeZone());
			Timestamp t = new Timestamp(p.getMillis());
			setter.setTimestamp(t, c);
		} else {
