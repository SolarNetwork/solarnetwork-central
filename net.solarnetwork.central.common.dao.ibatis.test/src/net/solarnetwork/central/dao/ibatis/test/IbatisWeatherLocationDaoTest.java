/* ==================================================================
 * IbatisWeatherLocationDaoTest.java - Oct 19, 2011 9:19:30 PM
 * 
...
import net.solarnetwork.central.dao.ibatis.IbatisWeatherLocationDao;
...
/**
 * Test case for the {@link IbatisWeatherLocationDao} class.
 * 
 * @author matt
 * @version $Revision$
 */
public class IbatisWeatherLocationDaoTest extends AbstractIbatisDaoTestSupport {

	@Autowired private WeatherLocationDao dao;
	@Autowired private WeatherSourceDao weatherSourceDao;
