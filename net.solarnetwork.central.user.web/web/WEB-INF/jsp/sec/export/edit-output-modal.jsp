<%--
 ...
 --%>
<form id="edit-export-output-config-modal" class="modal fade edit-config" action="<c:url value='/u/sec/export/configs/output'/>" method="post" tabindex="-1" role="dialog">
