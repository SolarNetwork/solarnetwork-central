<%--
 ...
 --%>
<form id="edit-export-data-config-modal" class="modal fade edit-config export" action="<c:url value='/u/sec/export/configs/data'/>" method="post" tabindex="-1" role="dialog">
