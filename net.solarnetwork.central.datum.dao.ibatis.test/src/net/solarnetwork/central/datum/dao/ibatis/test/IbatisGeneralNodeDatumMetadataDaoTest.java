...
import net.solarnetwork.central.datum.dao.ibatis.IbatisGeneralNodeDatumMetadataDao;
...
/**
 * Test cases for the {@link IbatisGeneralNodeDatumMetadataDao} class.
 * 
 * @author matt
 * @version 1.0
 */
public class IbatisGeneralNodeDatumMetadataDaoTest extends AbstractIbatisDaoTestSupport {

	private static final String TEST_SOURCE_ID = "test.source";
	private static final String TEST_SOURCE_ID_2 = "test.source.2";

	@Autowired
	private IbatisGeneralNodeDatumMetadataDao dao;
