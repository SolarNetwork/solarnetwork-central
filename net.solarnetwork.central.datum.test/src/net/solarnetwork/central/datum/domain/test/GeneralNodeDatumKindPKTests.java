...
public class GeneralNodeDatumKindPKTests {
	...
	public void stringValue() {
		GeneralNodeDatumKindPK pk = new GeneralNodeDatumKindPK(TEST_NODE_ID, TEST_DATE, TEST_SOURCE_ID,
				TEST_KIND);
		assertThat("String value", pk.toString(),
				equalTo("GeneralNodeDatumKindPK{nodeId=" + TEST_NODE_ID + ", sourceId=" + TEST_SOURCE_ID
						+ ", created=" + TEST_DATE + ", kind=" + TEST_KIND + "}"));
	}
	...
	public void idValue() {
		GeneralNodeDatumKindPK pk = new GeneralNodeDatumKindPK(TEST_NODE_ID, TEST_DATE, TEST_SOURCE_ID,
				TEST_KIND);
		assertThat("ID value", pk.getId(), equalTo(DigestUtils.sha1Hex(
				"n=" + TEST_NODE_ID + ";s=" + TEST_SOURCE_ID + ";c=" + TEST_DATE + ";k=" + TEST_KIND)));
	}

	@Test
	public void equalsEqual() {
		GeneralNodeDatumKindPK pk1 = new GeneralNodeDatumKindPK(TEST_NODE_ID, TEST_DATE, TEST_SOURCE_ID,
				TEST_KIND);
		GeneralNodeDatumKindPK pk2 = new GeneralNodeDatumKindPK(TEST_NODE_ID, new DateTime(TEST_DATE),
