/* ==================================================================
 * MyBatisHardwareControlDatumDao.java - Nov 13, 2014 6:56:10 AM
 * 
...
/**
 * MyBatis implementation of {@link HardwareControlDatumDao}.
 * 
 * @author matt
 * @version 1.0
 */
public class MyBatisHardwareControlDatumDao extends
		BaseMyBatisFilterableDatumDao<HardwareControlDatum, HardwareControlDatumMatch, NodeDatumFilter>
		implements HardwareControlDatumDao {

	/**
	 * Default constructor.
	 */
	public MyBatisHardwareControlDatumDao() {
