...
public class MoveDatumAuxiliary implements CallableStatementCreator, SqlProvider {
	...
	public CallableStatement createCallableStatement(Connection con) throws SQLException {
		...
		stmt.setString(9, JsonUtils.getJSONString(
				to.getSamplesFinal() != null ? to.getSamplesFinal().getAccumulating() : null, null));
		stmt.setString(10, JsonUtils.getJSONString(
				to.getSamplesStart() != null ? to.getSamplesStart().getAccumulating() : null, null));
