/* ==================================================================
 * UserEventBasicSerializerTests.java - 19/03/2026 5:53:20 am
 * 
...
/**
 * Test cases for the {@link UserEventBasicSerializer}.
 * 
 * @author matt
 * @version 1.0
 */
public class UserEventBasicSerializerTests {
	...
	public void setup() {
		...
		mod.addSerializer(UserEvent.class, UserEventBasicSerializer.INSTANCE);
	...
	@Test
	public void json_noData() throws IOException {
		// GIVEN
		UserEvent event = new UserEvent(randomLong(), uuidGenerator.generate(),
				new String[] { randomString(), randomString() }, randomString(), null);
	...
	@Test
	public void json_noMessage() throws IOException {
		// GIVEN
		UserEvent event = new UserEvent(randomLong(), uuidGenerator.generate(),
				new String[] { randomString(), randomString() }, null, "{\"foo\":1}");
