...
public final class Ec2VirtualMachine extends BaseObjectEntity<String> implements VirtualMachine {
	...
	public static VirtualMachineState virtualMachineStateForInstanceState(InstanceState state) {
		...
		return switch (s) {
			case 0 -> VirtualMachineState.Starting;
			case 16 -> VirtualMachineState.Running;
			case 32, 64 -> VirtualMachineState.Stopping;
			case 48 -> VirtualMachineState.Terminated;
			case 80 -> VirtualMachineState.Stopped;
