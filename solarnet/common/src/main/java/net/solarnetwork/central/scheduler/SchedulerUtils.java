...
public final class SchedulerUtils {
	...
	public static Event createJobCompleteEvent(Event job) {
		return createJobFinishedEvent(SchedulerConstants.TOPIC_JOB_COMPLETE,
				(String) job.getProperty(SchedulerConstants.JOB_ID),
				(String) job.getProperty(SchedulerConstants.JOB_GROUP), null);
	}
	...
	public static Event createJobFailureEvent(Event job, Throwable t) {
		return createJobFinishedEvent(SchedulerConstants.TOPIC_JOB_FAILURE,
				(String) job.getProperty(SchedulerConstants.JOB_ID),
				(String) job.getProperty(SchedulerConstants.JOB_GROUP), t);
	}
	 ...
	 *        the job ID
	 * @param jobGroup
	 *        the optional job group
	 * @param e
	 *        the optional exception
	 * @return the acknowledgment event
	 */
	public static Event createJobFinishedEvent(String topic, String jobId, String jobGroup,
			Throwable e) {
