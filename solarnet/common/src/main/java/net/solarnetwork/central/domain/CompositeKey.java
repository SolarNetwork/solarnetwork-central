...
public interface CompositeKey {
	 ...
	 * allowed to be {@code null}. In this situation a placeholder value
	 ...
	 * @return the associated key component, or {@code null} if the component is
	 *         not assigned, or the index is out of range
	 */
	@Nullable
	 ...
	 * @param val
	 *        the value to convert, or {@code null} to use an "unassigned" value
	...
	<T> T keyComponentValue(int index, @Nullable Object val);
	 ...
	 *        {@code null} to create a new key from scratch, or else
	 ...
	 */
	CompositeKey createKey(@Nullable CompositeKey template, Object... components);
