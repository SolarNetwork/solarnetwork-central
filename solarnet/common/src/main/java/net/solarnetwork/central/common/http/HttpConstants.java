...
public final class HttpConstants {
	...
	public static final String OAUTH_TOKEN_URL_SETTING = "oauthTokenUrl";
	 ...
	 */
	public static final String OAUTH_AUTHENTICATION_METHOD_SETTING = "oauthAuthenticationMethod";

	/** A standard OAuth client identifier setting name. */
	public static final String OAUTH_CLIENT_ID_SETTING = "oauthClientId";

	/** A standard OAuth client secret setting name. */
	public static final String OAUTH_CLIENT_SECRET_SETTING = "oauthClientSecret";

	/** A standard OAuth access token. */
	public static final String OAUTH_ACCESS_TOKEN_SETTING = "oauthAccessToken";

	/** A standard OAuth refresh token. */
	public static final String OAUTH_REFRESH_TOKEN_SETTING = "oauthRefreshToken";

	/** A standard OAuth state value. */
	public static final String OAUTH_STATE_SETTING = "oauthState";
	...
	public static final String AUTHORIZATION_STATE_PARAM = "state";
