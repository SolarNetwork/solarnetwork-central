...
public final class RsaKeyHelper {
			...
			switch (type) {
				case "RSA PRIVATE KEY" -> {
					...
					RSAPrivateCrtKeySpec privSpec = new RSAPrivateCrtKeySpec(key.getModulus(),
							key.getPublicExponent(), key.getPrivateExponent(), key.getPrime1(),
							key.getPrime2(), key.getExponent1(), key.getExponent2(),
							key.getCoefficient());
	...
	public static String encodePublicKey(RSAPublicKey key, String id) {
