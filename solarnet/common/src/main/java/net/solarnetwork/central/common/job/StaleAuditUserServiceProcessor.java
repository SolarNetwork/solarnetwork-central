/* ==================================================================
 * StaleAuditUserServiceProcessor.java - 29/05/2024 3:39:36 pm
 * 
 ...
 * @version 1.0
 */
public class StaleAuditUserServiceProcessor extends TieredStoredProcedureStaleRecordProcessor {

	/** The default {@code jdbcCall} value. */
	public static final String DEFAULT_SQL = "{? = call solardatm.process_one_aud_stale_user(?)}";
