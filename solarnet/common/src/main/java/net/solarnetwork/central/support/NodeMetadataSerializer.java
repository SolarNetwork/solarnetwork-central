 ...
 * @version 3.0
 */
public class NodeMetadataSerializer extends StdSerializer<@Nullable NodeMetadata> {
	...
	@Override
	public void serialize(@Nullable NodeMetadata meta, JsonGenerator generator,
