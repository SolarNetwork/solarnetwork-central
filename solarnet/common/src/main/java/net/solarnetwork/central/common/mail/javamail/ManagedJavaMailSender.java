...
public class ManagedJavaMailSender implements JavaMailSender {
	...
	public void send(MimeMessage mimeMessage) throws MailException {
		doWithSender(sender -> sender.send(mimeMessage));
	}

	@Override
	public void send(MimeMessage... mimeMessages) throws MailException {
		doWithSender(sender -> sender.send(mimeMessages));
	}

	@Override
	public void send(MimeMessagePreparator mimeMessagePreparator) throws MailException {
		doWithSender(sender -> sender.send(mimeMessagePreparator));
	}

	@Override
	public void send(MimeMessagePreparator... mimeMessagePreparators) throws MailException {
		doWithSender(sender -> sender.send(mimeMessagePreparators));
	}
