...
public final class LongStringCompositePK extends BasePK implements Serializable, Cloneable,
	 ...
	 */
	public static final String UNASSIGNED_ENTITY_ID = EntityConstants.UNASSIGNED_STRING_ID;
	...
	@Override
	public int compareTo(@Nullable LongStringCompositePK o) {
		if ( o == null ) {
			return 1;
		}
	...
	public boolean equals(@Nullable Object obj) {
		...
		if ( !(obj instanceof LongStringCompositePK other) ) {
			return false;
		}
	...
	@Override
	public LongStringCompositePK createKey(@Nullable CompositeKey template, Object... components) {
		...
		return new LongStringCompositePK(k1, k2);
	}
