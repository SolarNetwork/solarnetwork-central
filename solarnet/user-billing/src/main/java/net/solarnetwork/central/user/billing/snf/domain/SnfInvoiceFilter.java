...
public class SnfInvoiceFilter extends SimplePagination {
	 ...
	 */
	public final void setUnpaidOnly(boolean unpaidOnly) {
	 ...
	 *         (i.e. issued credit)
	 */
	public final boolean isIgnoreCreditOnly() {
	 ...
	 *        (i.e. issued credit)
	 */
	public final void setIgnoreCreditOnly(boolean ignoreCreditOnly) {
