...
public interface ChargePointActionStatusFilter
		extends ChargePointCriteria, IdentifierCriteria, ChargePointConnectorCriteria, UserCriteria,
		ActionCriteria, DateRangeCriteria, SortCriteria, PaginationCriteria {
