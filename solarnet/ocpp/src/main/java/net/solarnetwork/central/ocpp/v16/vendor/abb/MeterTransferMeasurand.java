/* ==================================================================
 * MeterTransferMeasurand.java - 7/02/2023 11:11:40 am
 * 
...
public record MeterTransferMeasurand(String name, String phase) {
	...
	/**
	 * Attempt to parse a {@link MeterTransferMeasurand} instance from a key
	 * value.
	 * 
	 * @param key
	...
	public static MeterTransferMeasurand forKey(String key) {
		...
		Matcher m = PHASED_KEY_PATTERN.matcher(key);
		if ( m.matches() ) {
			return new MeterTransferMeasurand(m.group(1), m.group(2));
		}
		return new MeterTransferMeasurand(key, null);
	}
}
