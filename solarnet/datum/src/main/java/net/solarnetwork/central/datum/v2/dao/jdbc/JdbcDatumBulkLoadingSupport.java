...
public class JdbcDatumBulkLoadingSupport {
	 ...
	 *
	 * <p>
	 * This will call {@link #persistStreamStats(Connection, Iterable)} will the
	 * values collected in {@link #getStreamStats()}, and then clear the map.
	 * </p>
	 *
	 * @param connection
	 ...
	 * @return a {@link StreamDatum}, if possible to convert
	 */
	private @Nullable StreamDatum datumStreamDatum(GeneralObjectDatum<?> datum) {
	 ...
	 * {@link #updateStatsForDatum(DatumIdentity, Datum, UUID)}.
	 * </p>
	 *
