/* ==================================================================
 * SelectStaleAuditDatum.java - 23/11/2020 8:51:47 am
 *
 ...
 * @since 3.8
 */
public final class SelectStaleAuditDatum implements PreparedStatementCreator, SqlProvider {
	...
	private void sqlSelect(StringBuilder buf) {
		...
		buf.append("	datum.aud_kind,\n");
		buf.append("	datum.created\n");
	}

	private void sqlFrom(StringBuilder buf) {
		buf.append("FROM solardatm.aud_stale_datm datum\n");
	}
	...
	private void sqlWhere(StringBuilder buf) {
		...
		if ( filter.getAggregation() != null ) {
			where.append("\tAND datum.aud_kind = ?\n");
			idx++;
		}
