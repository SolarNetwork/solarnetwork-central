 ...
 * @version 1.0
 */
public class GeneralLocationDatumMatch extends GeneralLocationDatum
		implements GeneralLocationDatumFilterMatch {
	 ...
	 */
	public GeneralLocationDatumMatch(GeneralLocationDatumPK id) {
		super(id);
	}
	 ...
	 */
	@JsonCreator
	public GeneralLocationDatumMatch(@JsonProperty("locationId") Long locationId,
