 ...
 * @since 3.8
 */
public class AuditDatumAccumulativeEntityRowMapper implements RowMapper<AuditDatum> {

	/** A default mapper instance. */
	public static final RowMapper<AuditDatum> INSTANCE = new AuditDatumAccumulativeEntityRowMapper();

	@Override
	public AuditDatum mapRow(ResultSet rs, int rowNum) throws SQLException {
		UUID streamId = nonnull(getUuid(rs, 1, StreamDatum.UNASSIGNED_STREAM_ID), "Stream ID");
