...
public interface CombiningCriteria {
	...
	/**
	 * Test if a {@link CombiningType} is specified in this criteria.
	 *
	 * @return {@code true} if a {@link CombiningType} is specified
	 * @since 1.1
	 */
	default boolean hasCombiningTypeCriteria() {
		return getCombiningType() != null;
	}
