...
public enum SkyCondition {
	...
	/**
	 * Get a nighttime equivalent value for a given SkyCondition.
	 *
	 * <p>
	 ...
	 * </p>
	 *
	 * @return the nighttime equivalent SkyCondition
	 */
	public SkyCondition getNightEquivalent() {
		return switch (this) {
			case Clear -> ClearNight;
			case FewClouds -> FewCloudsNight;
			default -> this;
		};
	}
