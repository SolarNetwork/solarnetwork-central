...
public class DbDatumStreamStoredProcedureTests extends BaseDatumJdbcTestSupport {
	...
	public void findStreamMetadata_node() {
		...
		assertThat("Instantaneous names match",
				result.propertyNamesForType(DatumSamplesType.Instantaneous),
				arrayContaining(m.propertyNamesForType(DatumSamplesType.Instantaneous)));
		assertThat("Accumulating names match",
				result.propertyNamesForType(DatumSamplesType.Accumulating),
				arrayContaining(m.propertyNamesForType(DatumSamplesType.Accumulating)));
		assertThat("Status names match", result.propertyNamesForType(DatumSamplesType.Status),
				arrayContaining(m.propertyNamesForType(DatumSamplesType.Status)));
	}
	...
	public void findStreamMetadata_nodeOverLocation() {
		...
		assertThat("Instantaneous names match",
				nodeMeta.propertyNamesForType(DatumSamplesType.Instantaneous),
				arrayContaining(m.propertyNamesForType(DatumSamplesType.Instantaneous)));
		assertThat("Accumulating names match",
				nodeMeta.propertyNamesForType(DatumSamplesType.Accumulating),
				arrayContaining(m.propertyNamesForType(DatumSamplesType.Accumulating)));
		assertThat("Status names match", nodeMeta.propertyNamesForType(DatumSamplesType.Status),
				arrayContaining(m.propertyNamesForType(DatumSamplesType.Status)));
	}
}
