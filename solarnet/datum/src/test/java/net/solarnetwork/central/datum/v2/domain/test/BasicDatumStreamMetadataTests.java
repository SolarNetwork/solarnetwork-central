...
public class BasicDatumStreamMetadataTests {
	...
	public void typeArrays() {
		...
		assertThat("Instantaneous props", m.propertyNamesForType(DatumSamplesType.Instantaneous),
				arrayContaining("one", "two", "three"));
		assertThat("Accumulating props", m.propertyNamesForType(DatumSamplesType.Accumulating),
				arrayContaining("four", "five"));
		assertThat("Status props", m.propertyNamesForType(DatumSamplesType.Status),
				arrayContaining("six"));
		assertThat("Tag props", m.propertyNamesForType(DatumSamplesType.Tag), nullValue());
	}
	...
	public void typeArrays_null() {
		...
		assertThat("Accumulating props", m.propertyNamesForType(DatumSamplesType.Accumulating),
				nullValue());
		assertThat("Status props", m.propertyNamesForType(DatumSamplesType.Status), nullValue());
		assertThat("Tag props", m.propertyNamesForType(DatumSamplesType.Tag), nullValue());
	}
