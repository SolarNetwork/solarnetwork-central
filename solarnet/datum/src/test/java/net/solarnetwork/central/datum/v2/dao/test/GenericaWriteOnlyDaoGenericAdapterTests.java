/* ==================================================================
 * GenericaWriteOnlyDaoGenericAdapterTests.java - 21/03/2026 1:20:10 pm
 *
...
/**
 * Test cases for the {@link GenericWriteOnlyDaoDatumAdapter} class.
 *
 * @author matt
 * @version 1.0
 */
...
public class GenericaWriteOnlyDaoGenericAdapterTests {

	@Mock
	private GenericWriteOnlyDao<Object, DatumPK> delegateDao;

	private GenericWriteOnlyDaoDatumAdapter dao;

	@BeforeEach
	public void setup() {
		dao = new GenericWriteOnlyDaoDatumAdapter(delegateDao);
	}
	...
	public void persist_StreamDatum() {
		...
		given(delegateDao.persist(any(StreamDatum.class))).willReturn(delegateDaoResult);

		// WHEN
		final DatumPK result = dao.store(entity);
	...
	public void persist_Datum() {
		...
		given(delegateDao.persist(any(Datum.class))).willReturn(delegateDaoResult);
