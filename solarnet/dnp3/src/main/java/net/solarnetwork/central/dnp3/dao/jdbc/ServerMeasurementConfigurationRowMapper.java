...
public class ServerMeasurementConfigurationRowMapper
	...
	public ServerMeasurementConfiguration mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		MeasurementType type = MeasurementType.forCode(rs.getString(++p).charAt(0));

		final var conf = new ServerMeasurementConfiguration(userId, serverId, entityId, ts, nodeId,
				sourceId, type, property);
