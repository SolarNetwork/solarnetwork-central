/* ==================================================================
 * CertificateFilter.java - 5/08/2023 12:14:16 pm
 * 
...
/**
 * A filter for DNP3 user-related certificates.
 * 
 * @author matt
 * @version 1.0
 */
public interface CertificateFilter
		extends UserCriteria, CertificateCriteria, EnabledCriteria, PaginationCriteria {
