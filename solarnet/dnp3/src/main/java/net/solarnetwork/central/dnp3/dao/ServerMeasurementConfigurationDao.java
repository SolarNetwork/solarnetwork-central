/* ==================================================================
 * ServerMeasurementConfigurationDao.java - 5/08/2023 11:54:33 am
 *
...
/**
 * DAO API for {@link ServerMeasurementConfiguration} entities.
 *
 * @author matt
 * @version 1.0
 */
public interface ServerMeasurementConfigurationDao extends
	...
	@Override
	default ServerMeasurementConfiguration entityKey(UserLongIntegerCompositePK id) {
		return new ServerMeasurementConfiguration(id, Instant.EPOCH, 0L, "", MeasurementType.AnalogInput,
				"");
	}
