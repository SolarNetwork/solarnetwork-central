...
/**
 * Support for INSERT ... ON CONFLICT {@link ServerControlConfiguration}
 * entities.
 *
 * @author matt
 * @version 1.0
 */
public final class UpsertServerControlConfiguration implements PreparedStatementCreator, SqlProvider {
	...
	private final ServerControlConfiguration entity;
