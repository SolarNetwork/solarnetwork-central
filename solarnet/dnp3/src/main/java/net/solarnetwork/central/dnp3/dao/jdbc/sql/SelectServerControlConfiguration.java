/* ==================================================================
 * SelectServerControlConfiguration.java - 6/08/2023 6:15:18 pm
 *
...
/**
 * Select {@link ServerControlConfiguration} entities.
 *
 * @author matt
 * @version 1.0
 */
public final class SelectServerControlConfiguration
	...
	private void sqlWhere(StringBuilder buf) {
		...
		if ( filter.hasUserCriteria() ) {
			idx += whereOptimizedArrayContains(filter.getUserIds(), "dsc.user_id", where);
		}
	...
	private void sqlOrderBy(StringBuilder buf) {
		buf.append("ORDER BY dsc.user_id, dsc.server_id, dsc.idx");
	}
