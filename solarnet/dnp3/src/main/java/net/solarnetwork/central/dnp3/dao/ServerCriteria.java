...
public interface ServerCriteria {
	 ...
	 */
	default @Nullable Long getServerId() {
	 ...
	 * {@link #hasServerCriteria()} returns {@code true}, to avoid nullness
	 * warnings.
	 * </p>
	 *
	 *
	 * @return the first server ID (presumed non-null)
	 * @since 1.1
	 */
	@SuppressWarnings("NullAway")
	default Long serverId() {
		return getServerId();
	}
	 ...
	 * </p>
	 *
	 * @return array of server IDs (presumed non-null)
	 * @since 1.1
	 */
	@SuppressWarnings("NullAway")
	default Long[] serverIds() {
		return getServerIds();
	}
