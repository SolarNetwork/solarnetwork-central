...
package net.solarnetwork.central.user.datum.flux.aop;
...
public class UserFluxSecurityAspect extends AuthorizationSupport {
	 ...
	 *        the user ID
	 */
	@Pointcut("execution(* net.solarnetwork.central.user.datum.flux.biz.UserFluxBiz.*ForUser(..)) && args(userId,..)")
	 ...
	 *        the user ID
	 */
	@Pointcut("execution(* net.solarnetwork.central.user.datum.flux.biz.UserFluxBiz.*Configuration(..)) && args(userId,..)")
	 ...
	 *        the user key
	 */
	@Pointcut("execution(* net.solarnetwork.central.user.datum.flux.biz.UserFluxBiz.*Configuration(..)) && args(userKey,..)")
	...
	@Before(value = "updateConfigurationForUserId(userId)", argNames = "userId")
