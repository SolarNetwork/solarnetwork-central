...
import net.solarnetwork.central.user.datum.flux.dao.jdbc.JdbcUserFluxAggregatePublishConfigurationDao;
import net.solarnetwork.central.user.datum.flux.dao.jdbc.JdbcUserFluxDefaultAggregatePublishConfigurationDao;
