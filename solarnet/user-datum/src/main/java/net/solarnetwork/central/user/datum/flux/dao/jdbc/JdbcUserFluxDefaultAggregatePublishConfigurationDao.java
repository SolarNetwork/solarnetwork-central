...
import net.solarnetwork.central.user.datum.flux.dao.jdbc.sql.SelectUserFluxDefaultAggregatePublishConfiguration;
import net.solarnetwork.central.user.datum.flux.dao.jdbc.sql.UpsertUserFluxDefaultAggregatePublishConfiguration;
