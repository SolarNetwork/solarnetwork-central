...
package net.solarnetwork.central.user.datum.event.biz.dao.test;
...
public class DaoUserEventHookBizTests {
	...
	public void setup() {
		...
		ms.setBasename("net/solarnetwork/central/user/datum/event/biz/dao/test/test-messages-01");
	...
	public void availableTopics_localizedByService() {
		...
		ResourceBundleMessageSource ms = new ResourceBundleMessageSource();
		ms.setBasename("net/solarnetwork/central/user/datum/event/biz/dao/test/test-messages-02");
	...
	public void availableTopics_multipleProducers_overlapTopic() {
		...
		ResourceBundleMessageSource ms = new ResourceBundleMessageSource();
		ms.setBasename("net/solarnetwork/central/user/datum/event/biz/dao/test/test-messages-03");
