/* ==================================================================
 * UserDatumInputSecurityAspect.java - 25/02/2024 12:12:22 pm
 *
...
/**
 * Security enforcing AOP aspect for {@link UserDatumInputBiz}.
 *
 * @author matt
 * @version 1.0
 */
@Aspect
@Component
public class UserDatumInputSecurityAspect extends AuthorizationSupport {
	 ...
	 */
	public UserDatumInputSecurityAspect(SolarNodeOwnershipDao nodeOwnershipDao) {
	 ...
	 *        the user ID
	 */
	@Pointcut("execution(* net.solarnetwork.central.user.din.biz.UserDatumInputBiz.*ForUser(..)) && args(userId,..)")
