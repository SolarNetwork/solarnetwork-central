...
public class EGaugeCloudDatumStreamService_HttpTests {
	...
	@Test
	public void datum_auth404() throws IOException {
		// GIVEN
		...
		server.enqueue(new MockResponse().setStatus("404 Not Found")
		...
		/*-
		// request token
		server.enqueue(new MockResponse().setStatus("200 OK")
				.setHeader(CONTENT_TYPE, APPLICATION_JSON_VALUE).setBody("""
						{"jwt":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.\
						eyJybG0iOiJlR2F1Z2UgQWRtaW5pc3RyYXRpb24iLCJ1c\
						3IiOiJvd25lciIsImJlZyI6MTczMDMxNTI4NCwibHRtIj\
						o2MDAsImdlbiI6MH0.BKuK9KGnXfhL7y8wv1u-TTKd_bs\
						nzZjpdWvFopznT3s","rights":["save"]}
						"""));
		*/
