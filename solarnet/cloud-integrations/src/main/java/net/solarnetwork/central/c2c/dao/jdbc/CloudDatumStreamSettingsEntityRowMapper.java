...
public class CloudDatumStreamSettingsEntityRowMapper
		implements RowMapper<CloudDatumStreamSettingsEntity> {

	/** A default instance. */
	public static final RowMapper<CloudDatumStreamSettingsEntity> INSTANCE = new CloudDatumStreamSettingsEntityRowMapper();
