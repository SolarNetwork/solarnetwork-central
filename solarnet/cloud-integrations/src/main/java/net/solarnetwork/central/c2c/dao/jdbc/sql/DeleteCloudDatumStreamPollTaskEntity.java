/* ==================================================================
 * DeleteCloudDatumStreamPollTaskEntity.java - 11/11/2025 6:35:47 am
 *
...
/**
 * Support for DELETE for {@link CloudDatumStreamPollTaskEntity} entities.
 *
 * @author matt
 * @version 1.0
 */
public class DeleteCloudDatumStreamPollTaskEntity implements PreparedStatementCreator, SqlProvider {
	 ...
	 *        the filter
	 */
	public DeleteCloudDatumStreamPollTaskEntity(CloudDatumStreamPollTaskFilter filter) {
		super();
	...
	private void sqlCore(StringBuilder buf) {
		buf.append("""
				DELETE FROM solardin.cin_datum_stream_poll_task
				""");
	}
