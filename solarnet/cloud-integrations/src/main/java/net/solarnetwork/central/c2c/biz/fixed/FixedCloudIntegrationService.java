/* ==================================================================
 * FixedCloudIntegrationService.java - 13 Sept 2026 6:19:19 pm
 *
...
/**
 * {@link CloudIntegrationService} for statically-configured ("fixed") data.
 *
 * @author matt
 * @version 1.0
 */
public class FixedCloudIntegrationService extends BaseCloudIntegrationService {

	/** The service identifier. */
	public static final String SERVICE_IDENTIFIER = "s10k.c2c.i9n.fixed";
	 ...
	 */
	public FixedCloudIntegrationService(Collection<CloudDatumStreamService> datumStreamServices,
			Collection<CloudControlService> controlServices, UserEventAppenderBiz userEventAppenderBiz,
			TextEncryptor encryptor) {
		super(SERVICE_IDENTIFIER, "Fixed Integration Service", datumStreamServices, controlServices,
