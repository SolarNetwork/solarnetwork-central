/* ==================================================================
 * CloudDatumStreamRakeTaskResetAbandoned.java - 22/09/2025 11:50:50 am
 *
...
/**
 * Job to process cloud datum stream rake tasks whose state is executing but
 * their execute date is really old.
 *
 * @author matt
 * @version 1.0
 */
public class CloudDatumStreamRakeTaskResetAbandoned extends JobSupport {
	 ...
	 */
	public CloudDatumStreamRakeTaskResetAbandoned(CloudDatumStreamRakeService service) {
	...
	public void run() {
		...
		if ( count > 0 ) {
			log.warn("Reset {} abandoned datum stream rake tasks", count);
		}
	}
