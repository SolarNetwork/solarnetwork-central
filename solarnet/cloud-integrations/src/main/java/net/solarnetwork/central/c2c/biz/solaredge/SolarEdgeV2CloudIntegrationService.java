/* ==================================================================
 * SolarEdgeV2CloudIntegrationService.java - 12 Aug 2026 7:50:34 am
 *
...
/**
 * SolarEdge V2 implementation of {@link CloudIntegrationService}.
 *
 * @author matt
 * @version 1.0
 */
public class SolarEdgeV2CloudIntegrationService extends BaseRestOperationsCloudIntegrationService {

	/** The service identifier. */
	public static final String SERVICE_IDENTIFIER = "s10k.c2c.i9n.solaredge.v2";

	/** The URL template for listing sites. */
	public static final String SITES_LIST_URL = "/sites";

	/** The API key authorization HTTP header name. */
	...
	public static final URI BASE_URI = URI.create("https://monitoringapi.solaredge.com/v2");
	 ...
	 */
	public SolarEdgeV2CloudIntegrationService(Collection<CloudDatumStreamService> datumStreamServices,
		...
		super(SERVICE_IDENTIFIER, "SolarEdge", datumStreamServices, List.of(), userEventAppenderBiz,
				...
				new SolarEdgeV2RestOperationsHelper(clock,
						LoggerFactory.getLogger(SolarEdgeV2CloudIntegrationService.class),
	...
	public Result<Void> validate(CloudIntegrationConfiguration integration, Locale locale) {
		...
		// validate by requesting the V2 available sites
		try {
			final String response = restOpsHelper.httpGet(
					"List sites", integration, String.class, _ -> UriComponentsBuilder.fromUri(BASE_URI)
							.path(SITES_LIST_URL).buildAndExpand().toUri(),
