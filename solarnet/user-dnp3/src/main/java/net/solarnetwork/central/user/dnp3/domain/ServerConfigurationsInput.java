...
public class ServerConfigurationsInput {
	...
	@Valid
	private @Nullable List<ServerMeasurementConfigurationInput> measurementConfigs;

	@Valid
	private @Nullable List<ServerControlConfigurationInput> controlConfigs;
	 ...
	 */
	public final @Nullable List<ServerMeasurementConfigurationInput> getMeasurementConfigs() {
	 ...
	 */
	public final void setMeasurementConfigs(
			@Nullable List<ServerMeasurementConfigurationInput> measurementConfigs) {
		this.measurementConfigs = measurementConfigs;
	}
	 ...
	 * @return the configurations
	 */
	public final @Nullable List<ServerControlConfigurationInput> getControlConfigs() {
	 ...
	 *        the configurations to set
	 */
	public final void setControlConfigs(@Nullable List<ServerControlConfigurationInput> controlConfigs) {
		this.controlConfigs = controlConfigs;
	}
