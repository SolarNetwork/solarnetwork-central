...
public class ActorDetails implements Actor {
	 ...
	 * 
	 * <p>
	 * This constructor sets {@code publishAllowed} to {@literal true} and
	 * configures the allowed node IDs to just {@code nodeId}. This is designed
	 * to be used for publishing by a node to its own topics.
	 * </p>
	 * 
	 * @param userId
	 *        the node owner ID
