...
public class UserKeyPairEntity extends BasicUserEntity<UserKeyPairEntity, UserStringCompositePK>
	...
	public UserKeyPairEntity(UserStringCompositePK id, Instant created, Instant modified,
		...
		this.keystore = Arrays.copyOf(secret, requireNonNullArgument(secret, "keystore").length);
	}
	 ...
	 *         if any argument is {@literal null}
	 */
	public UserKeyPairEntity(Long userId, String key, Instant created, Instant modified, byte[] secret) {
		this(new UserStringCompositePK(userId, key), created, modified, secret);
	}
