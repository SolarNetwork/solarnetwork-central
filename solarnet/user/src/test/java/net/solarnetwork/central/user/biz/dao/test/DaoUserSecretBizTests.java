...
public class DaoUserSecretBizTests {
	...
	public void setup() {
		...
		biz = new DaoUserSecretBiz(clock, secretsBiz, certificateService, keyPairDao, secretDao,
				hmacKey);
	}
	...
	public void saveUserKeyPair() {
		...
		input.setKeyPem(pem);
		UserKeyPair result = biz.saveUserKeyPair(userId, key, input);

		// THEN
		// @formatter:off
		final String passwordKey = DaoUserSecretBiz.secretsBizKeyForKeyPair(daoKeyPairEntity);
	...
	public void deleteUserKeyPair() {
		...
		// THEN
		// @formatter:off
		final String passwordKey = DaoUserSecretBiz.secretsBizKeyForKeyPair(
				daoKeyPairEntity);
