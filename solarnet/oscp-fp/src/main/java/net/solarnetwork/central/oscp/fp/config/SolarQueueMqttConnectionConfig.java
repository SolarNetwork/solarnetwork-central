...
public class SolarQueueMqttConnectionConfig {
	...
	public MqttStats solarQueueMqttStats() {
		return new MqttStats("SolarQueue", 500, OscpMqttCountStat.values());
	}
	...
	public ObservableMqttConnection solarQueueMqttConnection(@Qualifier(SOLARQUEUE) MqttStats stats,
