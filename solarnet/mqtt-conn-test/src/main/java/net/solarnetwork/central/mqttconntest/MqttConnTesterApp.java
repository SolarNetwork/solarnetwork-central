/* ==================================================================
 * MqttConnTesterApp.java - 4/10/2021 3:18:06 PM
 * 
...
package net.solarnetwork.central.mqttconntest;
...
// @formatter:on
public class MqttConnTesterApp {

	private static final Logger LOG = LoggerFactory.getLogger(MqttConnTesterApp.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(MqttConnTesterApp.class, args);
	}
