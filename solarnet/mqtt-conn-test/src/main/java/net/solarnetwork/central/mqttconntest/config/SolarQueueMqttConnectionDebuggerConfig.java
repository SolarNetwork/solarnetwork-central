...
public class SolarQueueMqttConnectionDebuggerConfig {

	@Value("${app.solarqueue.debugger.topic:instr/OCPP_v16}")
	private String mqttDebuggerTopic = "instr/OCPP_v16";

	@Bean
	@Qualifier(SOLARQUEUE)
	public MqttConnectionDebugger solarQueueMqttConnectionDebugger(Executor executor) {
