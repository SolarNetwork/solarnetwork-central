...
import net.solarnetwork.central.datum.export.jobs.DatumExportProcessorJob;
...
/**
 * Datum export jobs configuration.
 * 
 * @author matt
 * @version 1.0
 */
@Configuration
public class DatumExportJobsConfig {
	...
	@Autowired
	private DatumExportBiz datumExportBiz;

	@ConfigurationProperties(prefix = "app.job.datum.export.processor")
	@Bean
	...
	@ConfigurationProperties(prefix = "app.job.datum.export.cleaner")
	@Bean
