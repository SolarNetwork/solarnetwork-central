...
public class AppEventConfig {
	...
	public ApplicationEventMulticaster applicationEventMulticaster(
			@Qualifier(APP_EVENTS) TaskExecutor taskExecutor) {
	...
	@Bean
	public SimpleAppEventManager eventManager(@Qualifier(APP_EVENTS) TaskExecutor taskExecutor) {
