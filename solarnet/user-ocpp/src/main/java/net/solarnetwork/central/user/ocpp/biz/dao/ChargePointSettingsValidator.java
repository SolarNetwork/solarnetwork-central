/* ==================================================================
 * ChargePointSettingsValidator.java - 24/07/2022 8:59:24 am
 * 
...
/**
 * Validator for {@link ChargePointSettings} objects.
 * 
 * @author matt
 * @version 1.0
 */
public class ChargePointSettingsValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return ChargePointSettings.class.isAssignableFrom(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {
		ChargePointSettings o = (ChargePointSettings) target;
		if ( o.getUserId() == null ) {
			errors.rejectValue("userId", "ocpp.settings.error.userId.required",
					"The user ID is required.");
		}
		if ( o.getChargePointId() == null ) {
			errors.rejectValue("chargePointId", "ocpp.settings.error.chargePointId.required",
					"The charger ID is required.");
		}
