...
public class SelectEndpointAuthConfiguration
	...
	private void sqlCore(StringBuilder buf) {
		buf.append("""
				SELECT dac.user_id, dac.endpoint_id, dac.cred_id, dac.created, dac.modified, dac.enabled
				FROM solardin.din_endpoint_auth_cred dac
				""");
	}
	...
	private void sqlOrderBy(StringBuilder buf) {
		buf.append("ORDER BY dac.user_id, dac.endpoint_id, dac.cred_id");
	}
