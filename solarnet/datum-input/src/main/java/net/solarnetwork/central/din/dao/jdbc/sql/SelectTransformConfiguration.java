...
public class SelectTransformConfiguration
	 ...
	 *        the filter
	 */
	public SelectTransformConfiguration(TransformFilter filter) {
	 ...
	 *        the filter
	 */
	public SelectTransformConfiguration(TransformFilter filter, int fetchSize) {
		super();
	...
	private void sqlCore(StringBuilder buf) {
		buf.append("""
				SELECT dx.user_id, dx.id, dx.created, dx.modified
					, dx.cname, dx.sident, dx.sprops
				FROM solardin.din_xform dx
				""");
	}
	...
	private void sqlOrderBy(StringBuilder buf) {
		buf.append("ORDER BY dx.user_id, dx.id");
	}
