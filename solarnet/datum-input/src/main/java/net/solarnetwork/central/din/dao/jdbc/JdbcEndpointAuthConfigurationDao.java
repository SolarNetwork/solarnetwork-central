...
import net.solarnetwork.central.din.dao.EndpointAuthFilter;
import net.solarnetwork.central.din.dao.jdbc.sql.SelectEndpointAuthConfiguration;
import net.solarnetwork.central.din.dao.jdbc.sql.UpsertEndpointAuthConfiguration;
...
public class JdbcEndpointAuthConfigurationDao implements EndpointAuthConfigurationDao {
	...
	private static final String TABLE_NAME = "solardin.din_endpoint_auth_cred";
