/* ==================================================================
 * JdbcTransformConfigurationDaoTests.java - 21/02/2024 1:47:35 pm
 *
...
/**
 * Test cases for the {@link JdbcTransformConfigurationDao} class.
 *
 * @author matt
 * @version 1.0
 */
public class JdbcTransformConfigurationDaoTests extends AbstractJUnit5JdbcDaoTestSupport {
	...
	public void insert() {
		...
		List<Map<String, Object>> data = allTransformConfigurationData(jdbcTemplate);
	...
	public void findForUser() throws Exception {
		...
		for ( int i = 0; i < count; i++ ) {
			for ( int u = 0; u < userCount; u++ ) {
				...
				TransformConfiguration conf = newTransformConfiguration(userId, randomString(),
						randomString(), props);
