/* ==================================================================
 * UpdateHeartbeatDateTests.java - 21/08/2022 7:58:36 am
 * 
...
/**
 * Test cases for the {@link UpdateHeartbeatDate} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class UpdateHeartbeatDateTests {
	...
	public void unassignedId() {
		...
		assertThrows(IllegalArgumentException.class, () -> {
			new UpdateHeartbeatDate(OscpRole.CapacityProvider, id, expected, ts).getSql();
		});
	}
	...
	public void capacityProvider_sql() {
		...
		// WHEN
		String sql = new UpdateHeartbeatDate(OscpRole.CapacityProvider, id, expected, ts).getSql();
	...
	public void capacityProvider_nullExpected_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new UpdateHeartbeatDate(OscpRole.CapacityProvider, id, expected, ts)
	...
	public void capacityOptimizer_sql() {
		...
		// WHEN
		String sql = new UpdateHeartbeatDate(OscpRole.CapacityOptimizer, id, expected, ts).getSql();
	...
	public void capacityOptimizer_nullExpected_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new UpdateHeartbeatDate(OscpRole.CapacityOptimizer, id, expected, ts)
				.createPreparedStatement(con);
