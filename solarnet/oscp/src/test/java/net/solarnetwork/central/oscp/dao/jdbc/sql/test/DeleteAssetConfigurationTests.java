...
/**
 * Test cases for the {@link DeleteAssetConfiguration} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class DeleteAssetConfigurationTests {
	...
	public void single_sql() {
		...
		// WHEN
		String sql = new DeleteAssetConfiguration(filter).getSql();

		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql,
				equalToTextResource("delete-asset-conf-one.sql", TestSqlResources.class, SQL_COMMENT));
	}
	...
	public void single_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new DeleteAssetConfiguration(filter).createPreparedStatement(con);
