...
/**
 * Test cases for the {@link DeleteCapacityGroupConfiguration} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class DeleteCapacityGroupConfigurationTests {
	...
	public void single_sql() {
		...
		// WHEN
		String sql = new DeleteCapacityGroupConfiguration(filter).getSql();

		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource("delete-capacity-group-conf-one.sql",
	...
	public void single_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new DeleteCapacityGroupConfiguration(filter)
		...
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"delete-capacity-group-conf-one.sql", TestSqlResources.class, SQL_COMMENT));
