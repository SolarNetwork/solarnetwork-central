/* ==================================================================
 * SelectExternalSystemForMeasurementTests.java - 8/09/2022 10:46:29 am
 * 
...
/**
 * Test cases for the {@link SelectExternalSystemForMeasurement} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class SelectExternalSystemForMeasurementTests {
	...
	public void capacityProvider_forUpdateSkip_sql() {
		...
		// WHEN
		String sql = new SelectExternalSystemForMeasurement(OscpRole.CapacityProvider,
				ONE_FOR_UPDATE_SKIP).getSql();

		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource(
				"select-capacity-provider-measurement-locked.sql", TestSqlResources.class, SQL_COMMENT));
	}
	...
	public void capacityProvider_forUpdateSkip_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new SelectExternalSystemForMeasurement(OscpRole.CapacityProvider,
	...
	public void capacityOptimizer_forUpdateSkip_sql() {
		...
		// WHEN
		String sql = new SelectExternalSystemForMeasurement(OscpRole.CapacityOptimizer,
				ONE_FOR_UPDATE_SKIP).getSql();

		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql,
				equalToTextResource("select-capacity-optimizer-measurement-locked.sql",
	...
	public void capacityOptimizer_forUpdateSkip_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new SelectExternalSystemForMeasurement(OscpRole.CapacityOptimizer,
				ONE_FOR_UPDATE_SKIP).createPreparedStatement(con);
