...
/**
 * Test cases for the {@link SelectCapacityProviderConfiguration} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class SelectCapacityProviderConfigurationTests {
	...
	public void multi_sql() {
		...
		assertThat("SQL matches", sql, equalToTextResource("select-capacity-provider-conf.sql",
	...
	public void multi_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new SelectCapacityProviderConfiguration(filter)
		...
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"select-capacity-provider-conf.sql", TestSqlResources.class, SQL_COMMENT));
	...
	public void single_sql() {
		...
		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource("select-capacity-provider-conf-one.sql",
				TestSqlResources.class, SQL_COMMENT));
	}
	...
	public void single_prep() throws SQLException {
		...
		log.debug("Generated SQL:\n{}", sqlCaptor.getValue());
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"select-capacity-provider-conf-one.sql", TestSqlResources.class, SQL_COMMENT));
		assertThat("Connection statement returned", result, sameInstance(stmt));
		thenPrepStatement(result, filter);
	}
	...
	public void flexibilityProvider_single_sql() {
		...
		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource("select-capacity-provider-conf-fp-one.sql",
				TestSqlResources.class, SQL_COMMENT));
	}
	...
	public void flexibilityProvider_single_prep() throws SQLException {
		...
		log.debug("Generated SQL:\n{}", sqlCaptor.getValue());
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"select-capacity-provider-conf-fp-one.sql", TestSqlResources.class, SQL_COMMENT));
		assertThat("Connection statement returned", result, sameInstance(stmt));
		thenPrepStatement(result, filter);
	}
	...
	public void flexibilityProvider_multi_sql() {
		...
		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource("select-capacity-provider-conf-fp.sql",
				TestSqlResources.class, SQL_COMMENT));
	}
	...
	public void flexibilityProvider_multi_prep() throws SQLException {
		...
		log.debug("Generated SQL:\n{}", sqlCaptor.getValue());
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"select-capacity-provider-conf-fp.sql", TestSqlResources.class, SQL_COMMENT));
		assertThat("Connection statement returned", result, sameInstance(stmt));
		thenPrepStatement(result, filter);
	}
