/* ==================================================================
 * SelectCapacityGroupConfigurationTests.java - 12/08/2022 5:02:05 pm
 * 
...
/**
 * Test cases for the {@link SelectCapacityGroupConfiguration} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class SelectCapacityGroupConfigurationTests {
	...
	public void multi_sql() {
		...
		assertThat("SQL matches", sql, equalToTextResource("select-capacity-group-conf.sql",
	...
	public void multi_prep() throws SQLException {
		...
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"select-capacity-group-conf.sql", TestSqlResources.class, SQL_COMMENT));
	...
	public void single_sql() {
		...
		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource("select-capacity-group-conf-one.sql",
				TestSqlResources.class, SQL_COMMENT));
	}
	...
	public void single_prep() throws SQLException {
		...
		log.debug("Generated SQL:\n{}", sqlCaptor.getValue());
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"select-capacity-group-conf-one.sql", TestSqlResources.class, SQL_COMMENT));
		assertThat("Connection statement returned", result, sameInstance(stmt));
		thenPrepStatement(result, filter);
	}
}
