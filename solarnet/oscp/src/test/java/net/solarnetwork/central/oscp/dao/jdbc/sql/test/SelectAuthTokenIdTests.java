...
public class SelectAuthTokenIdTests {
	...
	public void selectFlexibilityProvider_sql() {
		...
		// WHEN
		String sql = new SelectAuthTokenId(AuthTokenType.FlexibilityProvider, token).getSql();
	...
	public void selectFlexibilityProvider_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new SelectAuthTokenId(AuthTokenType.FlexibilityProvider, token)
	...
	public void selectCapacityProvider() {
		...
		// WHEN
		String sql = new SelectAuthTokenId(AuthTokenType.CapacityProvider, token).getSql();
	...
	public void selectCapacityOptimizer() {
		...
		// WHEN
		String sql = new SelectAuthTokenId(AuthTokenType.CapacityOptimizer, token).getSql();
