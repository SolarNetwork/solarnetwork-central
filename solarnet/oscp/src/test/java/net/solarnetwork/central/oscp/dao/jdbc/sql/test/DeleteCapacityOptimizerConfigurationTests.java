...
/**
 * Test cases for the {@link DeleteCapacityOptimizerConfiguration} class.
 * 
 * @author matt
 * @version 1.0
 */
@ExtendWith(MockitoExtension.class)
public class DeleteCapacityOptimizerConfigurationTests {
	...
	public void single_sql() {
		...
		// WHEN
		String sql = new DeleteCapacityOptimizerConfiguration(filter).getSql();

		// THEN
		log.debug("Generated SQL:\n{}", sql);
		assertThat("SQL matches", sql, equalToTextResource("delete-capacity-optimizer-conf-one.sql",
	...
	public void single_prep() throws SQLException {
		...
		// WHEN
		PreparedStatement result = new DeleteCapacityOptimizerConfiguration(filter)
		...
		assertThat("Generated SQL", sqlCaptor.getValue(), equalToTextResource(
				"delete-capacity-optimizer-conf-one.sql", TestSqlResources.class, SQL_COMMENT));
