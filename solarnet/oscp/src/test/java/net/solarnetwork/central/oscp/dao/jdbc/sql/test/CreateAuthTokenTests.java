...
import net.solarnetwork.central.oscp.dao.jdbc.sql.CreateAuthToken.TokenType;
...
public class CreateAuthTokenTests {
	...
	public void createFlexibilityProvider() {
		...
		// WHEN
		String sql = new CreateAuthToken(TokenType.FlexibilityProvider, id).getSql();
	...
	public void createCapacityProvider() {
		...
		// WHEN
		String sql = new CreateAuthToken(TokenType.CapacityProvider, id).getSql();
	...
	public void createCapacityOptimizer() {
		...
		// WHEN
		String sql = new CreateAuthToken(TokenType.CapacityOptimizer, id).getSql();
