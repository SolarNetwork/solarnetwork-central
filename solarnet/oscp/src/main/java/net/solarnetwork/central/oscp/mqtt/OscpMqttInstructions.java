...
public interface OscpMqttInstructions extends OscpUserEvents {
	...
	List<String> OSCP_INSTRUCTION_TAGS = List.of(OSCP_TAG, INSTRUCTION_TAG);

	/** User event tags for OSCP instruction error events. */
	List<String> OSCP_INSTRUCTION_ERROR_TAGS = List.of(OSCP_TAG, INSTRUCTION_TAG, ERROR_TAG);

	/** User event tags for OSCP instruction input events. */
	List<String> OSCP_INSTRUCTION_IN_TAGS = List.of(OSCP_TAG, INSTRUCTION_TAG, INPUT_TAG);

	/** User event tags for OSCP instruction output events. */
	List<String> OSCP_INSTRUCTION_OUT_TAGS = List.of(OSCP_TAG, INSTRUCTION_TAG, OUTPUT_TAG);
