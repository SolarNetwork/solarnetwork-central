...
public interface CapacityOptimizerConfigurationDao
		extends ExternalSystemConfigurationDao<CapacityOptimizerConfiguration> {

	@Override
	default CapacityOptimizerConfiguration entityKey(UserLongCompositePK id) {
		return new CapacityOptimizerConfiguration(id, Instant.EPOCH, "", UNASSIGNED_ENTITY_ID, Pending);
	}
