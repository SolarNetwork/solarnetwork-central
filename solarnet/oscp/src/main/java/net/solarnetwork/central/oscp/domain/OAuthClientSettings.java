 ...
 * @param clientSecret
 *        the client secret, which may be {@code null} if stored in some other
 *        context
 * @author matt
 * @version 1.0
 */
public record OAuthClientSettings(String tokenUrl, String clientId, @Nullable String clientSecret) {
