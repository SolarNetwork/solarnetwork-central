 ...
 * @version 1.0
 */
public final class UpdateCapacityGroupMeasurementDate implements PreparedStatementCreator, SqlProvider {
	 ...
	 */
	public UpdateCapacityGroupMeasurementDate(OscpRole type, UserLongCompositePK id,
			@Nullable Instant expected, Instant ts) {
		super();
