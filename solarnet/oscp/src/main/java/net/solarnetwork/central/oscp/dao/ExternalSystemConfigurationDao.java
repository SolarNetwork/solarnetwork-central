...
public interface ExternalSystemConfigurationDao<C extends BaseOscpExternalSystemConfiguration<C>>
	...
	List<String> CAPACITY_PROVIDER_HEARTBEAT_TAGS = List.of(OscpUserEvents.OSCP_TAG,
	...
	List<String> CAPACITY_PROVIDER_HEARTBEAT_ERROR_TAGS = List.of(OscpUserEvents.OSCP_TAG,
			OscpUserEvents.CAPACITY_PROVIDER_TAG, OscpUserEvents.HEARTBEAT_TAG,
			OscpUserEvents.ERROR_TAG);

	/** User event tags for Capacity Optimizer heartbeat events. */
	List<String> CAPACITY_OPTIMIZER_HEARTBEAT_TAGS = List.of(OscpUserEvents.OSCP_TAG,
	...
	List<String> CAPACITY_OPTIMIZER_HEARTBEAT_ERROR_TAGS = List.of(OscpUserEvents.OSCP_TAG,
			OscpUserEvents.CAPACITY_OPTIMIZER_TAG, OscpUserEvents.HEARTBEAT_TAG,
			OscpUserEvents.ERROR_TAG);

	/** User event tags for Capacity Provider measurement events. */
	List<String> CAPACITY_PROVIDER_MEASUREMENT_TAGS = List.of(OscpUserEvents.OSCP_TAG,
	...
	List<String> CAPACITY_PROVIDER_MEASUREMENT_ERROR_TAGS = List.of(OscpUserEvents.OSCP_TAG,
			OscpUserEvents.CAPACITY_PROVIDER_TAG, OscpUserEvents.MEASUREMENT_TAG,
			OscpUserEvents.ERROR_TAG);

	/** User event tags for Capacity Optimizer measurement events. */
	List<String> CAPACITY_OPTIMIZER_MEASUREMENT_TAGS = List.of(OscpUserEvents.OSCP_TAG,
	...
	List<String> CAPACITY_OPTIMIZER_MEASUREMENT_ERROR_TAGS = List.of(OscpUserEvents.OSCP_TAG,
			OscpUserEvents.CAPACITY_OPTIMIZER_TAG, OscpUserEvents.MEASUREMENT_TAG,
			OscpUserEvents.ERROR_TAG);
