...
/**
 * Update the offline date of an external system configuration.
 *
 * @author matt
 * @version 1.0
 */
public final class UpdateOfflineDate implements PreparedStatementCreator, SqlProvider {
