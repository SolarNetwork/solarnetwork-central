 ...
 * @version 1.0
 */
public final class InsertHeartbeatDate implements PreparedStatementCreator, SqlProvider {
	 ...
	 */
	public InsertHeartbeatDate(OscpRole type, UserLongCompositePK id, @Nullable Instant ts) {
		super();
