...
public interface OptimizerCriteria {
	 ...
	 */
	default @Nullable Long getOptimizerId() {
	 ...
	 * {@link #hasOptimizerCriteria()} returns {@code true}, to avoid nullness
	 * warnings.
	 * </p>
	 *
	 * @return the first optimizer ID (presumed non-null)
	 * @since 1.1
	 */
	@SuppressWarnings("NullAway")
	default Long optimizerId() {
	 ...
	 * </p>
	 *
	 * @return array of optimizer IDs (presumed non-null)
	 * @since 1.1
	 */
	@SuppressWarnings("NullAway")
	default Long[] optimizerIds() {
		return getOptimizerIds();
	}
