...
public interface AssetConfigurationDao
	...
	@Override
	default AssetConfiguration entityKey(UserLongCompositePK id) {
		return new AssetConfiguration(id, Instant.EPOCH, "", UNASSIGNED_ENTITY_ID, "",
				OscpRole.FlexibilityProvider, UNASSIGNED_ENTITY_ID, "", AssetCategory.Charging);
	}
