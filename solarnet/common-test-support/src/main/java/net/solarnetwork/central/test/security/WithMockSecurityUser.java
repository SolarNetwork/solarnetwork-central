...
public @interface WithMockSecurityUser {
	 ...
	 * The default user ID.
	 */
	public static final String DEFAULT_USERNAME = "test1@localhost";

	/**
	 * The default name.
	 */
	public static final String DEFAULT_NAME = "Tester 1";
	 ...
	 * @return the username
	 */
	String username() default WithMockSecurityUser.DEFAULT_USERNAME;
	 ...
	 * @return the name
	 */
	String name() default WithMockSecurityUser.DEFAULT_NAME;
