/* ==================================================================
 * WebConfigTests.java - 16/09/2026 9:12:40 am
 *
...
import net.solarnetwork.central.reg.config.WebConfig;
...
public class WebConfigTests extends AbstractJUnit5CentralTransactionalTest {
	...
	public void cors_api_preflight() throws Exception {
		// @formatter:off
		mvc.perform(options("/api/v1/sec/user/auth-tokens")
	...
	@Test
	public void cors_browserPage_notAllowed() throws Exception {
		// @formatter:off
