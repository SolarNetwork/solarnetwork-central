/* ==================================================================
 * UserAlertController_SourcesWebTests.java - 22/09/2026 9:05:12 am
 *
...
/**
 * Web integration tests for the {@link UserAlertController} class node source
 * support.
 *
 * @author matt
 * @version 1.0
...
public class UserAlertController_SourcesWebTests {
	...
	public void nodeSources() throws Exception {
		// WHEN
		// @formatter:off
		final String result = mvc.perform(get("/u/sec/alerts/node/{nodeId}/sources", nodeId)
	...
	public void nodeSources_otherUserPrivateNode() throws Exception {
		// WHEN
		// @formatter:off
		mvc.perform(get("/u/sec/alerts/node/{nodeId}/sources", otherNodeId)
				.accept(MediaType.APPLICATION_JSON)
			)
