<%--
 ...
 --%>
<form id="edit-datum-export-date-modal" class="modal fade edit-config export" action="<c:url value='/u/sec/export/configs/{id}/date'/>" method="post" tabindex="-1" role="dialog">
