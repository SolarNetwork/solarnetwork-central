...
public class NodeInstructionController {
	...
	public String queueInstruction(HttpServletRequest request, NodeInstruction input, Model model) {
	...
	public String activeInstructions(HttpServletRequest request, @RequestParam("nodeId") Long nodeId,
			Model model) {
	...
	public String viewInstruction(HttpServletRequest request, @RequestParam("id") Long instructionId,
			Model model) {
