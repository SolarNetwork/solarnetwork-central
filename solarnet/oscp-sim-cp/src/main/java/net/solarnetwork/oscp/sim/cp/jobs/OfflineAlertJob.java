...
public class OfflineAlertJob extends JobSupport {
	...
	private static final Logger log = LoggerFactory.getLogger(OfflineAlertJob.class);
	...
	public void run() {
		...
		int updated = dao.processExpiredOfflines((conf) -> log
				.warn("Discovered offline system {}, offline since {}", conf, conf.getOfflineDate()));
